...
namespace Laboratorio_Arboles_Binarios_de_Busqueda
{
    class ArbolBinarioBusqueda:ArbolBinario
    {
        ...
        protected Nodo buscar2(Nodo raizSub, Comparador2 buscado)
        {
            if (raizSub == null)
                return null;
        ...
        //método interno para realizar la operación
        protected Nodo eliminar2(Nodo raizSub, Comparador2 dato)
        {
            //if (raizSub == null)
            //     throw new Exception("No encontrado el nodo con la clave");
            if (raizSub == null)
